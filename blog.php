<?php
  class Blog {
    ...
    public function __construct($BlogID, $UserID, $Title, $Content, $CountryID,$ContinentID ) 
    {
      $this->BlogID    = $BlogID;
      $this->UserID    = $UserID;
      $this->Title    = $Title;
    ...
    public static function all() 
    {
      ...
      foreach($req->fetchAll() as $blog) 
          {
        $list[] = new Blog($blog['BlogID'], $blog['UserID'], $blog['Title'],$blog['Content'], $blog['CountryID'],$blog['ContinentID']);
      }
      return $list;
    }
