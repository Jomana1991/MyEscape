...
//	}
    ...
    public static function add() {
        ...
        $req = $db->prepare("Insert into blog(BlogID, UserID, Title, Content, CountryID, ContinentID, CategoryID) 
                                                values (:BlogID, :UserID, :Title, :Content, :CountryID, :ContinentID, :CategoryID)");
