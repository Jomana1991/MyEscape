<!--<link href="css/styles-general.css" rel="stylesheet" type="text/css"/>-->
    ...
    <br>
    <h3>Meet the team</h3> 
    <img src="/MyEscape/views/images/ash.jpg" class="avatar" alt="Ash" style="width:200px">     
    <img src="/MyEscape/views/images/dhanu.jpg" class="avatar" alt="Dhanu" style="width:200px">     
    
    <div class="flip-card">
        <div class="flip-card-inner">
            <div class="flip-card-front">
                <img src="/MyEscape/views/images/faith.jpg" class="avatar" alt="Faith" style="width:200px">
            </div>
            <div class="flip-card-back">
                <h4>Faith</h4> 
                <p>Top 3 places: Tanzania, Cuba, Brazil</p>
                <p>Favourite cuisine: Mexican</p> 
                <p>Travel tip: Never turn down a clean toilet opportunity!</p>
            </div>
        </div>
    </div>
    <img src="/MyEscape/views/images/jomana.jpg" class="avatar" alt="Jomana" style="width:200px">
        circle images - click on and see bio some how? country food or short bio
        responsive
    <br>
    <h3>Stay in touch</h3> 
